            ...
            try
            {
                ...
                switch (this.CurrentFlowFlag)
                {
                    case eFlowFlag.等待车辆:
                        ...
                        // Direction.Way1
                        if ((this.InductorCoil1 || this.InfraredSensor1) && Hardwarer.Wber.Weight > this.WbMinWeight)
                        {
                        ...
                        // Direction.Way2
                        else if ((this.InductorCoil2 || this.InfraredSensor2) && Hardwarer.Wber.Weight > this.WbMinWeight)
                        {
                            // 当读卡区域地感有信号，触发读卡或者车号识别
