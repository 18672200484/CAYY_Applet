...
namespace CMCS.CarTransport.Queue.Frms.SysManage
{
    public partial class Frm_Module_Oper : MetroForm
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBoxEx.Show("请输入模块完整名称！", "操作提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }

            if (string.IsNullOrEmpty(txtModuleName.Text))
            {
                MessageBoxEx.Show("请输入模块名称！", "操作提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            else
            {
                ...
                {
                    MessageBoxEx.Show("已经存在该模块完整名称！", "操作提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
            }
