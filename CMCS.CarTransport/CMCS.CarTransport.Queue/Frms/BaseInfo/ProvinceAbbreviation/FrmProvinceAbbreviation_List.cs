...
{
    public partial class FrmProvinceAbbreviation_List : MetroAppForm
    {
        /// <summary>
        /// 窗体唯一标识符
        /// </summary>
        public static string UniqueKey = "FrmProvinceAbbreviation_List";
        ...
        public FrmProvinceAbbreviation_List()
        {
            InitializeComponent();
        }

        private void FrmProvinceAbbreviation_List_Load(object sender, EventArgs e)
        {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(txt_PaName.Text)) this.SqlWhere += " and PaName like '%" + txt_PaName.Text + "%'";
            CurrentIndex = 0;
            BindData();
        }
        ...
        public void BindData()
        {
            ...
            List<CmcsProvinceAbbreviation> list = Dbers.GetInstance().SelfDber.ExecutePager<CmcsProvinceAbbreviation>(PageSize, CurrentIndex, tempSqlWhere + " order by PaName asc");
        ...
        {
            FrmProvinceAbbreviation_Oper frmEdit = new FrmProvinceAbbreviation_Oper(Guid.NewGuid().ToString(), eEditMode.新增);
